...
class PolicyAgreementViewController: UIViewController {
    ...
    let policyLinkWebVC = PrivacyAndTermsOfServiceWebViewController()
...
extension PolicyAgreementViewController {
    func setButtonActions() {
        policyAgreementView.nextButton.addTarget(self, action: #selector(goToBaseViewController), for: .touchUpInside)
